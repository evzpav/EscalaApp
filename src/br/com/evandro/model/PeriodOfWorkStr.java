...
public class PeriodOfWorkStr {
    ...
    public PeriodOfWorkStr(){

    }
    public PeriodOfWorkStr(String day, String startTime, String endTime, String intervalStart, String intervalEnd, Boolean working, Integer repeatFrequency) {
        this.day = day;
