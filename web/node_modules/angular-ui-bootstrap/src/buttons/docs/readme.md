...
* `btn-checkbox-false`
  _(Default: `false`)_ -
  Sets the value for the unchecked active.
  
* `btn-checkbox-true`
  _(Default: `true`)_ -
  Sets the value for the checked active.
  
* `ng-model`
  <small class="badge">$</small>
  <i class="glyphicon glyphicon-eye-open"></i> -
  Model where we set the checkbox active. By default `true` or `false`.
...
* `ng-model`
  <small class="badge">$</small>
  <i class="glyphicon glyphicon-eye-open"></i> -
  Model where we set the radio active. All radio buttons in a group should use the same `ng-model`.
